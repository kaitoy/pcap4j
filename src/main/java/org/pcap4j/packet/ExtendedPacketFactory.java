 ...
 * @since pcap4j 0.9.6
 */
public final class ExtendedPacketFactory implements PacketFactory {

  private static final ExtendedPacketFactory INSTANCE
    = new ExtendedPacketFactory();

  private ExtendedPacketFactory() {};

  /**
   *
   * @return
   */
  public static ExtendedPacketFactory getInstance() { return INSTANCE; }
