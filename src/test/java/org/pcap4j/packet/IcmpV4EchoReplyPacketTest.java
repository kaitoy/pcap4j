...
public class IcmpV4EchoReplyPacketTest {
  ...
  /**
   * {@link org.pcap4j.packet.IcmpV4EchoReplyPacket#getBuilder()} のためのテスト・メソッド。
   */
  @Test
  ...
  /**
   * {@link org.pcap4j.packet.IcmpV4EchoReplyPacket#newPacket(byte[])} のためのテスト・メソッド。
   */
  @Test
  public void testNewPacket() {
    IcmpV4EchoReplyPacket p
      = IcmpV4EchoReplyPacket.newPacket(packet.getRawData());
    assertEquals(packet, p);
  }

  /**
   * {@link org.pcap4j.packet.IcmpV4EchoReplyPacket#getHeader()} のためのテスト・メソッド。
   */
  @Test
