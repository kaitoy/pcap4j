...
public class Dot11ProbeRequestPacketTest extends AbstractPacketTest {
  ...
  private static final Logger logger
    = LoggerFactory.getLogger(Dot11ProbeRequestPacketTest.class);
    ...
    this.htControl
      = new Dot11HtControl.Builder()
          .linkAdaptationControl(
             new Dot11LinkAdaptationControl.Builder()
               .vhtMfb(false)
               .trq(true)
//               .maiOrAseli(Dot11LinkAdaptationControl.ASELI)
               .maiOrAseli(new Mai(true, (byte) 2))
               .mfsi((byte) 3)
//               .mfbOrAselc(new Aselc(AselCommand.SOUNDING_LABEL, (byte) 0x05))
               .mfbOrAselc((byte) 123)
               .build()
           )
    ...
    ratesAndBssMembershipSelectors
      .add(new BssMembershipSelector(true, Dot11BssMembershipSelector.HT_PHY));
    ratesAndBssMembershipSelectors.add(new Rate(true, (byte) 0x20));
    ratesAndBssMembershipSelectors
      .add(new BssMembershipSelector(false, Dot11BssMembershipSelector.HT_PHY));
    ...
    this.htCapabilities
      = new Dot11HTCapabilitiesElement.Builder()
          ...
          .supportedRxMcsIndexes(new boolean[] {
          ...
          .explicitNoncompressedBeamformingFeedbackCapability(BeamformingFeedbackCapability.DELAYED_AND_IMMEDIATE)
          .explicitCompressedBeamformingFeedbackCapability(BeamformingFeedbackCapability.IMMEDIATE)
    ...
    this.ssidList
      = new Dot11SsidListElement.Builder()
          .correctLengthAtBuild(true)
          .ssidList(ssids)
          .build();
