...
public class HdlcPppPacketTest extends AbstractPacketTest {
  ...
  private static final Logger logger
    = LoggerFactory.getLogger(HdlcPppPacketTest.class);
  ...
  public static void setUpBeforeClass() throws Exception {
    logger.info(
      "########## " + HdlcPppPacketTest.class.getSimpleName() + " START ##########"
    );
  }
  ...
  public void testNewPacket() {
    try {
      HdlcPppPacket p
        = HdlcPppPacket.newPacket(packet.getRawData(), 0, packet.getRawData().length);
