 ...
 * ICMPv6 Code
 *
 * @see <a href="http://www.iana.org/assignments/icmpv6-parameters/icmpv6-parameters.xml#icmpv6-parameters-3">IANA Registry</a>
 * @author Kaito Yamada
 * @since pcap4j 0.9.15
 */
public final class IcmpV6Code extends NamedNumber<Byte, IcmpV6Code> {
  ...
  /**
   * [Type 139 - ICMP Node Information Query]
   * The Data field contains an IPv6 address which is the Subject of this Query: 0
   */
  ...
  public static final IcmpV6Code SUBJECT_NAME
    = new IcmpV6Code((byte)1, "Subject name");

  /**
   * [Type 139 - ICMP Node Information Query]
   * The Data field contains an IPv4 address which is the Subject of this Query: 2
   */
  ...
  /**
   * [Type 140 - ICMP Node Information Response]
   * A successful reply. The Reply Data field may or may not be empty: 0
   */
  public static final IcmpV6Code SUCCESSFUL_REPLY
    = new IcmpV6Code((byte)0, "Successful reply");

  /**
   * [Type 140 - ICMP Node Information Response]
   * The Responder refuses to supply the answer. The Reply Data field will be empty: 1
   */
  public static final IcmpV6Code REFUSE
    = new IcmpV6Code((byte)1, "Refuse");

  /**
   * [Type 140 - ICMP Node Information Response]
   * The Qtype of the Query is unknown to the Responder. The Reply Data field will be empty: 2
   */
  public static final IcmpV6Code UNKNOWN_QTYPE
    = new IcmpV6Code((byte)2, "Unknown Qtype");
