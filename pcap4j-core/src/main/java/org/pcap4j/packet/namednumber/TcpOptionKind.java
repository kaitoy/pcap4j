 ...
 * TCP Option Kind
 *
 * @see <a href="http://www.iana.org/assignments/tcp-parameters/tcp-parameters.xml#tcp-parameters-1">IANA Registry</a>
 * @author Kaito Yamada
 * @since pcap4j 0.9.12
 */
public final class TcpOptionKind extends NamedNumber<Byte, TcpOptionKind> {
  ...
  public static final TcpOptionKind ECHO
    = new TcpOptionKind((byte)6, "Echo");

  /**
   * Echo Reply: 7
   */
  public static final TcpOptionKind ECHO_REPLY
    = new TcpOptionKind((byte)7, "Echo Reply");
  ...
  public static final TcpOptionKind CC
    = new TcpOptionKind((byte)11, "CC");

  /**
   * CC.NEW: 12
   */
  public static final TcpOptionKind CC_NEW
    = new TcpOptionKind((byte)12, "CC.NEW");

  /**
   * CC.ECHO: 13
   */
  public static final TcpOptionKind CC_ECHO
    = new TcpOptionKind((byte)13, "CC.ECHO");
  ...
  public static final TcpOptionKind SKEETER
    = new TcpOptionKind((byte)16, "Skeeter");

  /**
   * Bubba: 17
   */
  public static final TcpOptionKind BUBBA
    = new TcpOptionKind((byte)17, "Bubba");
  ...
  public static final TcpOptionKind MD5_SIGNATURE
    = new TcpOptionKind((byte)19, "MD5 Signature");
  ...
  public static final TcpOptionKind SNAP
    = new TcpOptionKind((byte)24, "SNAP");
