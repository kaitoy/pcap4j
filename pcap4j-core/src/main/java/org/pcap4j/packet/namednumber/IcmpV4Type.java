...
/**
 * ICMPv4 Type
 * @see <a href="http://www.iana.org/assignments/icmp-parameters/icmp-parameters.xml#icmp-parameters-types">IANA Registry</a>
 * @author Kaito Yamada
 * @since pcap4j 0.9.11
 */
public final class IcmpV4Type extends NamedNumber<Byte, IcmpV4Type> {
  ...
  public static final IcmpV4Type ECHO_REPLY
    = new IcmpV4Type((byte)0, "Echo Reply");
  ...
  public static final IcmpV4Type SOURCE_QUENCH
    = new IcmpV4Type((byte)4, "Source Quench");

  /**
   * Redirect: 5
   */
  public static final IcmpV4Type REDIRECT
    = new IcmpV4Type((byte)5, "Redirect");
  ...
  public static final IcmpV4Type TIME_EXCEEDED
    = new IcmpV4Type((byte)11, "Time Exceeded");

  /**
   * Parameter Problem: 12
   */
  public static final IcmpV4Type PARAMETER_PROBLEM
    = new IcmpV4Type((byte)12, "Parameter Problem");

  /**
   * Timestamp: 13
   */
  public static final IcmpV4Type TIMESTAMP
    = new IcmpV4Type((byte)13, "Timestamp");

  /**
   * Timestamp Reply: 14
   */
  public static final IcmpV4Type TIMESTAMP_REPLY
    = new IcmpV4Type((byte)14, "Timestamp Reply");
  ...
  public static final IcmpV4Type INFORMATION_REPLY
    = new IcmpV4Type((byte)16, "Information Reply");
  ...
  public static final IcmpV4Type TRACEROUTE
    = new IcmpV4Type((byte)30, "Traceroute");
  ...
  public static final IcmpV4Type IPV6_I_AM_HERE
    = new IcmpV4Type((byte)34, "IPv6 I-Am-Here");
  ...
  public static final IcmpV4Type DOMAIN_NAME_REPLY
    = new IcmpV4Type((byte)38, "Domain Name Reply");

  /**
   * SKIP: 39
   */
  public static final IcmpV4Type SKIP
    = new IcmpV4Type((byte)39, "SKIP");

  /**
   * Photuris: 40
   */
  public static final IcmpV4Type PHOTURIS
    = new IcmpV4Type((byte)40, "Photuris");
