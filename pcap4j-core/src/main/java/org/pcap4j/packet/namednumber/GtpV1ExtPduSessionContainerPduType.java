...
/**
 * @see <a href="https://www.etsi.org/deliver/etsi_ts/138400_138499/138415/15.02.00_60/ts_138415v150200p.pdf">ETSI
...
public final class GtpV1ExtPduSessionContainerPduType extends NamedNumber<Byte, GtpV1ExtPduSessionContainerPduType> {
  ...
  private static final Map<Byte, GtpV1ExtPduSessionContainerPduType> registry = new HashMap<Byte, GtpV1ExtPduSessionContainerPduType>();
  ...
  public GtpV1ExtPduSessionContainerPduType(Byte value, String name) {
    ...
    if ((value & 0xF0) != 0) {
      throw new IllegalArgumentException(
          value + " is invalid value. PDU type of GTPv1 PDU Session Container must be between 0 and 15");
    }
  }
   ...
   * @return a GtpV1ExtPduSessionContainerPduType object.
   */
  public static GtpV1ExtPduSessionContainerPduType register(GtpV1ExtPduSessionContainerPduType version) {
