 ...
 * ICMPv6 Type
 *
 * @see <a href="http://www.iana.org/assignments/icmpv6-parameters/icmpv6-parameters.xml#icmpv6-parameters-2">IANA Registry</a>
 * @author Kaito Yamada
 * @since pcap4j 0.9.15
 */
public final class IcmpV6Type extends NamedNumber<Byte, IcmpV6Type> {
  ...
  public static final IcmpV6Type FMIP_V6
    = new IcmpV6Type((byte)154, "FMIPv6");

  /**
   * RPL Control: 155
   */
  public static final IcmpV6Type RPL_CONTROL
    = new IcmpV6Type((byte)155, "RPL Control");
  ...
  static {
    ...
    registry.put(INVERSE_NEIGHBOR_DISCOVERY_SOLICITATION.value(), INVERSE_NEIGHBOR_DISCOVERY_SOLICITATION);
    registry.put(INVERSE_NEIGHBOR_DISCOVERY_ADVERTISEMENT.value(), INVERSE_NEIGHBOR_DISCOVERY_ADVERTISEMENT);
    registry.put(V2_MULTICAST_LISTENER_REPORT.value(), V2_MULTICAST_LISTENER_REPORT);
    registry.put(HOME_AGENT_ADDRESS_DISCOVERY_REQUEST.value(), HOME_AGENT_ADDRESS_DISCOVERY_REQUEST);
