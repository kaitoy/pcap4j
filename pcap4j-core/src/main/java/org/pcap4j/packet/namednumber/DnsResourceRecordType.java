 ...
 *
 * @see <a href="http://www.iana.org/assignments/dns-parameters/dns-parameters.xhtml#dns-parameters-4">IANA Registry</a>
 * @author Kaito Yamada
 * @since pcap4j 1.7.1
 */
public final class DnsResourceRecordType extends NamedNumber<Short, DnsResourceRecordType> {
  ...
  public static final DnsResourceRecordType CERT
    = new DnsResourceRecordType((short) 37, "CERT");

  /**
   * A6: 38
   */
  public static final DnsResourceRecordType A6
    = new DnsResourceRecordType((short) 38, "A6");

  /**
   * DNAME: 39
   */
  public static final DnsResourceRecordType DNAME
    = new DnsResourceRecordType((short) 39, "DNAME");

  /**
   * SINK: 40
   */
  public static final DnsResourceRecordType SINK
    = new DnsResourceRecordType((short) 40, "SINK");

  /**
   * OPT: 41
   */
  public static final DnsResourceRecordType OPT
    = new DnsResourceRecordType((short) 41, "OPT");

  /**
   * APL: 42
   */
  public static final DnsResourceRecordType APL
    = new DnsResourceRecordType((short) 42, "APL");
  ...
  public static final DnsResourceRecordType RRSIG
    = new DnsResourceRecordType((short) 46, "RRSIG");

  /**
   * NSEC: 47
   */
  public static final DnsResourceRecordType NSEC
    = new DnsResourceRecordType((short) 47, "NSEC");
  ...
  public static final DnsResourceRecordType DHCID
    = new DnsResourceRecordType((short) 49, "DHCID");

  /**
   * NSEC3: 50
   */
  public static final DnsResourceRecordType NSEC3
    = new DnsResourceRecordType((short) 50, "NSEC3");
  ...
  public static final DnsResourceRecordType TLSA
    = new DnsResourceRecordType((short) 52, "TLSA");
  ...
  public static final DnsResourceRecordType NINFO
    = new DnsResourceRecordType((short) 56, "NINFO");

  /**
   * RKEY: 57
   */
  public static final DnsResourceRecordType RKEY
    = new DnsResourceRecordType((short) 57, "RKEY");
  ...
  public static final DnsResourceRecordType SPF
    = new DnsResourceRecordType((short) 99, "SPF");

  /**
   * UINFO: 100
   */
  public static final DnsResourceRecordType UINFO
    = new DnsResourceRecordType((short) 100, "UINFO");

  /**
   * UID: 101
   */
  public static final DnsResourceRecordType UID
    = new DnsResourceRecordType((short) 101, "UID");

  /**
   * GID: 102
   */
  public static final DnsResourceRecordType GID
    = new DnsResourceRecordType((short) 102, "GID");
  ...
  public static final DnsResourceRecordType NID
    = new DnsResourceRecordType((short) 104, "NID");

  /**
   * L32: 105
   */
  public static final DnsResourceRecordType L32
    = new DnsResourceRecordType((short) 105, "L32");

  /**
   * L64: 106
   */
  public static final DnsResourceRecordType L64
    = new DnsResourceRecordType((short) 106, "L64");

  /**
   * LP: 107
   */
  public static final DnsResourceRecordType LP
    = new DnsResourceRecordType((short) 107, "LP");
  ...
  public static final DnsResourceRecordType URI
    = new DnsResourceRecordType((short) 256, "URI");
