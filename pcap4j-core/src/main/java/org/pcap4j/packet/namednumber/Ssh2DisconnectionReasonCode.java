/*_##########################################################################
  _##
  _##  Copyright (C) 2014-2015  Kaito Yamada
  _##
  _##########################################################################
*/
...
extends NamedNumber<Integer, Ssh2DisconnectionReasonCode> {
  ...
  static {
    ...
    registry.put(
      SSH_DISCONNECT_SERVICE_NOT_AVAILABLE.value(),
    ...
    registry.put(
      SSH_DISCONNECT_HOST_KEY_NOT_VERIFIABLE.value(),
    ...
    registry.put(
      SSH_DISCONNECT_AUTH_CANCELLED_BY_USER.value(),
