...
public final class UdpPort extends NamedNumber<Short, UdpPort> {
  ...
  public static final UdpPort TCPMUX
    = new UdpPort((short)1, "TCP Port Service Multiplexer");
  ...
  public static final UdpPort PCMAIL_SRV
    = new UdpPort((short)158, "PCMail Server");

  /**
   * NSS-Routing: 159
   */
  public static final UdpPort NSS_ROUTING
    = new UdpPort((short)159, "NSS-Routing");

  /**
   * SGMP-TRAPS: 160
   */
  public static final UdpPort SGMP_TRAPS
    = new UdpPort((short)160, "SGMP-TRAPS");
  ...
  public static final UdpPort DLS
    = new UdpPort((short)197, "Directory Location Service");
  ...
  public static final UdpPort ANET
    = new UdpPort((short)212, "ATEXSSTR");

  /**
   * IPX: 213
   */
  public static final UdpPort IPX
    = new UdpPort((short)213, "IPX");

  /**
   * VM PWSCS: 214
   */
  public static final UdpPort VMPWSCS
    = new UdpPort((short)214, "VM PWSCS");

  /**
   * Insignia Solutions SoftPC: 215
   */
  public static final UdpPort SOFTPC
    = new UdpPort((short)215, "Insignia Solutions SoftPC");
  ...
  public static final UdpPort DBASE
    = new UdpPort((short)217, "dBASE Unix");

  /**
   * Netix Message Posting Protocol: 218
   */
  public static final UdpPort MPP
    = new UdpPort((short)218, "Netix Message Posting Protocol");

  /**
   * Unisys ARPs: 219
   */
  public static final UdpPort UARPS
    = new UdpPort((short)219, "Unisys ARPs");
  ...
  public static final UdpPort ARNS
    = new UdpPort((short)384, "A Remote Network Server System");

  /**
   * IBM Application: 385
   */
  public static final UdpPort IBM_APP
    = new UdpPort((short)385, "IBM Application");

  /**
   * ASA Message Router Object Def.: 386
   */
  public static final UdpPort ASA
    = new UdpPort((short)386, "ASA Message Router Object Def.");
  ...
  public static final UdpPort UNIDATA_LDM
    = new UdpPort((short)388, "Unidata LDM");
  ...
  public static final UdpPort RMT
    = new UdpPort((short)411, "Remote MT Protocol");

  /**
   * Trap Convention Port: 412
   */
  public static final UdpPort SYNOPTICS_TRAP
    = new UdpPort((short)412, "Trap Convention Port");
  ...
  public static final UdpPort DDM_DFM
    = new UdpPort((short)447, "DDM-Distributed File Management");
  ...
  public static final UdpPort AS_SERVERMAP
    = new UdpPort((short)449, "AS Server Mapper");
  ...
  public static final UdpPort POWERBURST
    = new UdpPort((short)485, "Air Soft Power Burst");

  /**
   * avian: 486
   */
  public static final UdpPort AVIAN
    = new UdpPort((short)486, "avian");
  ...
  public static final UdpPort GSS_HTTP
    = new UdpPort((short)488, "gss-http");

  /**
   * nest-protocol: 489
   */
  public static final UdpPort NEST_PROTOCOL
    = new UdpPort((short)489, "nest-protocol");

  /**
   * micom-pfs: 490
   */
  public static final UdpPort MICOM_PFS
    = new UdpPort((short)490, "micom-pfs");

  /**
   * go-login: 491
   */
  public static final UdpPort GO_LOGIN
    = new UdpPort((short)491, "go-login");
  ...
  public static final UdpPort POV_RAY
    = new UdpPort((short)494, "POV-Ray");

  /**
   * intecourier: 495
   */
  public static final UdpPort INTECOURIER
    = new UdpPort((short)495, "intecourier");

  /**
   * PIM-RP-DISC: 496
   */
  public static final UdpPort PIM_RP_DISC
    = new UdpPort((short)496, "PIM-RP-DISC");
  ...
  public static final UdpPort NPMP_TRAP
    = new UdpPort((short)609, "npmp-trap");

  /**
   * npmp-local: 610
   */
  public static final UdpPort NPMP_LOCAL
    = new UdpPort((short)610, "npmp-local");

  /**
   * npmp-gui: 611
   */
  public static final UdpPort NPMP_GUI
    = new UdpPort((short)611, "npmp-gui");

  /**
   * HMMP Indication: 612
   */
  public static final UdpPort HMMP_IND
    = new UdpPort((short)612, "HMMP Indication");

  /**
   * HMMP Operation: 613
   */
  public static final UdpPort HMMP_OP
    = new UdpPort((short)613, "HMMP Operation");

  /**
   * SSLshell: 614
   */
  public static final UdpPort SSHELL
    = new UdpPort((short)614, "SSLshell");
  ...
  public static final UdpPort SUN_DR
    = new UdpPort((short)665, "Sun DR");

  /**
   * doom Id Software: 666
   */
  public static final UdpPort DOOM
    = new UdpPort((short)666, "doom Id Software");
  ...
  public static final UdpPort ASIPREGISTRY
    = new UdpPort((short)687, "asipregistry");
  ...
  public static final UdpPort CISCO_TDP
    = new UdpPort((short)711, "Cisco TDP");

  /**
   * TBRPF: 712
   */
  public static final UdpPort TBRPF
    = new UdpPort((short)712, "TBRPF");

  /**
   * IRIS over XPC: 713
   */
  public static final UdpPort IRIS_XPC
    = new UdpPort((short)713, "IRIS over XPC");

  /**
   * IRIS over XPCS: 714
   */
  public static final UdpPort IRIS_XPCS
    = new UdpPort((short)714, "IRIS over XPCS");

  /**
   * IRIS-LWZ: 715
   */
  public static final UdpPort IRIS_LWZ
    = new UdpPort((short)715, "IRIS-LWZ");

  /**
   * PANA Messages: 716
   */
  public static final UdpPort PANA
    = new UdpPort((short)716, "PANA Messages");
  ...
  public static final UdpPort NETVIEWDM2
    = new UdpPort((short)730, "IBM NetView DM/6000 send/tcp");
  ...
  public static final UdpPort DHCP_FAILOVER2
    = new UdpPort((short)847, "dhcp-failover 2");

  /**
   * GDOI: 848
   */
  public static final UdpPort GDOI
    = new UdpPort((short)848, "GDOI");

  /**
   * iSCSI: 860
   */
  public static final UdpPort ISCSI
    = new UdpPort((short)860, "iSCSI");

  /**
   * OWAMP-Control: 861
   */
  public static final UdpPort OWAMP_CONTROL
    = new UdpPort((short)861, "OWAMP-Control");
  ...
  public static final UdpPort ICLCNET_SVINFO
    = new UdpPort((short)887, "ICL coNETion server info");

  /**
   * AccessBuilder: 888
   */
  public static final UdpPort ACCESSBUILDER
    = new UdpPort((short)888, "AccessBuilder");

  /**
   * OMG Initial Refs: 900
   */
  public static final UdpPort OMGINITIALREFS
    = new UdpPort((short)900, "OMG Initial Refs");

  /**
   * SMPNAMERES: 901
   */
  public static final UdpPort SMPNAMERES
    = new UdpPort((short)901, "SMPNAMERES");
  ...
  public static final UdpPort NAS
    = new UdpPort((short)991, "Netnews Administration System");

  /**
   * telnet protocol over TLS/SSL: 992
   */
  public static final UdpPort TELNETS
    = new UdpPort((short)992, "telnet protocol over TLS/SSL");

  /**
   * imap4 protocol over TLS/SSL: 993
   */
  public static final UdpPort IMAPS
    = new UdpPort((short)993, "imap4 protocol over TLS/SSL");
  ...
  public static final UdpPort VSINET
    = new UdpPort((short)996, "vsinet");

  /**
   * maitrd: 997
   */
  public static final UdpPort MAITRD
    = new UdpPort((short)997, "maitrd");

  /**
   * puparp: 998
   */
  public static final UdpPort PUPARP
    = new UdpPort((short)998, "puparp");

  /**
   * Applix ac: 999
   */
  public static final UdpPort APPLIX
    = new UdpPort((short)999, "Applix ac");

  /**
   * cadlock2: 1000
   */
  public static final UdpPort CADLOCK2
    = new UdpPort((short)1000, "cadlock2");
