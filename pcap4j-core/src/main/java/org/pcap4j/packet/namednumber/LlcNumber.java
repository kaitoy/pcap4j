 ...
 *
 * @see <a href="http://www.iana.org/assignments/ieee-802-numbers/ieee-802-numbers.xhtml#ieee-802-numbers-3">IANA Registry</a>
 * @author Kaito Yamada
 * @since pcap4j 1.6.5
 */
public final class LlcNumber extends NamedNumber<Byte, LlcNumber> {
  ...
  public static final LlcNumber NULL_LSAP
    = new LlcNumber((byte)0, "NULL LSAP");
  ...
  public static final LlcNumber DOD_IP
    = new LlcNumber((byte)6, "DOD IP");

  /**
   * ProWay-LAN: 14
   */
  public static final LlcNumber PROWAY_LAN
    = new LlcNumber((byte)14, "ProWay-LAN");

  /**
   * EIA-RS 511: 78
   */
  public static final LlcNumber EIA_RS_511
    = new LlcNumber((byte)78, "EIA-RS 511");

  /**
   * ISI IP: 94
   */
  public static final LlcNumber ISI_IP
    = new LlcNumber((byte)94, "ISI IP");
