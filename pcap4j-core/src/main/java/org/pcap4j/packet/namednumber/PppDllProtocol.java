...
public final class PppDllProtocol extends NamedNumber<Short, PppDllProtocol> {
  ...
  public static final PppDllProtocol IPV4
    = new PppDllProtocol((short)0x0021, "IPv4");
  ...
  public static final PppDllProtocol ST_II
    = new PppDllProtocol((short)0x0033, "ST-II");
  ...
  public static final PppDllProtocol LBLB
    = new PppDllProtocol((short)0x0045, "LBLB");
  ...
  public static final PppDllProtocol PPP_SDTP
    = new PppDllProtocol((short)0x0049, "PPP-SDTP");
  ...
  public static final PppDllProtocol IPV6
    = new PppDllProtocol((short)0x0057, "IPv6");
  ...
  public static final PppDllProtocol VSNP
    = new PppDllProtocol((short)0x005b, "VSNP");

  /**
   * TRILL Network Protocol (TNP): 0x005d
   */
  public static final PppDllProtocol TNP
    = new PppDllProtocol((short)0x005d, "TNP");
  ...
  public static final PppDllProtocol CDP
    = new PppDllProtocol((short)0x0207, "CDP");
  ...
  public static final PppDllProtocol EDPCP
    = new PppDllProtocol((short)0x820d, "EDPCP");
  ...
  public static final PppDllProtocol CBCP
    = new PppDllProtocol((short)0xc029, "CBCP");
  ...
  public static final PppDllProtocol VSAP
    = new PppDllProtocol((short)0xc05b, "VSAP");
  ...
  public static final PppDllProtocol SIEP
    = new PppDllProtocol((short)0xc229, "SIEP");
  ...
  static {
    ...
    registry.put(SINGLE_LINK_COMPRESSION_IN_MULTILINK.value(), SINGLE_LINK_COMPRESSION_IN_MULTILINK);
    ...
    registry.put(MULTICHANNEL_FLOW_TREATMENT_PROTOCOL_0289.value(), MULTICHANNEL_FLOW_TREATMENT_PROTOCOL_0289);
    ...
    registry.put(CRAY_COMMUNICATIONS_CONTROL_PROTOCOL.value(), CRAY_COMMUNICATIONS_CONTROL_PROTOCOL);
    registry.put(CDPD_MOBILE_NETWORK_REGISTRATION_PROTOCOL.value(), CDPD_MOBILE_NETWORK_REGISTRATION_PROTOCOL);
    ...
    registry.put(IP6_HEADER_COMPRESSION_CONTROL_PROTOCOL.value(), IP6_HEADER_COMPRESSION_CONTROL_PROTOCOL);
    ...
    registry.put(INDIVIDUAL_LINK_ENCRYPTION_CONTROL_PROTOCOL.value(), INDIVIDUAL_LINK_ENCRYPTION_CONTROL_PROTOCOL);
    ...
    registry.put(SINGLE_LINK_COMPRESSION_IN_MULTILINK_CONTROL.value(), SINGLE_LINK_COMPRESSION_IN_MULTILINK_CONTROL);
    ...
    registry.put(APPLE_CLIENT_SERVER_PROTOCOL_CONTROL.value(), APPLE_CLIENT_SERVER_PROTOCOL_CONTROL);
    registry.put(MPLSCP.value(), MPLSCP);
    registry.put(IEEE_P1284_4_STANDARD_PROTOCOL_CONTROL.value(), IEEE_P1284_4_STANDARD_PROTOCOL_CONTROL);
    registry.put(ETSI_TETRA_TNP1_CONTROL_PROTOCOL.value(), ETSI_TETRA_TNP1_CONTROL_PROTOCOL);
    registry.put(MULTICHANNEL_FLOW_TREATMENT_PROTOCOL_8289.value(), MULTICHANNEL_FLOW_TREATMENT_PROTOCOL_8289);
    ...
    registry.put(SHIVA_PASSWORD_AUTHENTICATION_PROTOCOL.value(), SHIVA_PASSWORD_AUTHENTICATION_PROTOCOL);
    registry.put(CBCP.value(), CBCP);
    registry.put(BACP_BANDWIDTH_ALLOCATION_CONTROL_PROTOCOL.value(), BACP_BANDWIDTH_ALLOCATION_CONTROL_PROTOCOL);
    ...
    registry.put(CHALLENGE_HANDSHAKE_AUTHENTICATION_PROTOCOL.value(), CHALLENGE_HANDSHAKE_AUTHENTICATION_PROTOCOL);
    ...
    registry.put(STAMPEDE_BRIDGING_AUTHORIZATION_PROTOCOL.value(), STAMPEDE_BRIDGING_AUTHORIZATION_PROTOCOL);
    registry.put(PROPRIETARY_AUTHENTICATION_PROTOCOL_C281.value(), PROPRIETARY_AUTHENTICATION_PROTOCOL_C281);
    registry.put(PROPRIETARY_AUTHENTICATION_PROTOCOL_C283.value(), PROPRIETARY_AUTHENTICATION_PROTOCOL_C283);
    registry.put(PROPRIETARY_NODE_ID_AUTHENTICATION_PROTOCOL.value(), PROPRIETARY_NODE_ID_AUTHENTICATION_PROTOCOL);
  }
