...
public final class Dot11InformationElementId extends NamedNumber<Byte, Dot11InformationElementId> {
  ...
  static {
    ...
    registry.put(EXTENDED_CHANNEL_SWITCH_ANNOUNCEMENT.value(), EXTENDED_CHANNEL_SWITCH_ANNOUNCEMENT);
    ...
    registry.put(IE_20_40_BSS_INTOLERANT_CHANNEL_REPORT.value(), IE_20_40_BSS_INTOLERANT_CHANNEL_REPORT);
