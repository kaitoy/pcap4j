...
public class GtpV1ExtNRUPacket extends AbstractPacket {
    ...
    private static final long serialVersionUID = 7361463927403478496L;
    ...
    public static final class Builder extends AbstractBuilder
        ...
        /**
         * Get correctLengthAtBuild of header
         *
    ...
    public static class GtpV1ExtNRUHeader extends AbstractHeader{
        ...
        private static final long serialVersionUID = 1216791891825802706L;
        ...
        GtpV1ExtNRUHeader(byte[] rawData, int offset, int length) throws IllegalRawDataException {
            ...
            int currentOffsetInHeader = DL_discard_NR_PDCP_PDU_SN_OFFSET;
